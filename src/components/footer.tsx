  ...
  return (
    <footer className="text-white px-6 py-14 md:px-16 bg-gradient-to-r from-green-600 via-green-700 to-green-800 shadow-md">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white select-none">
              CashNest Loan Service
            </span>
          </div>

          <p className="text-sm leading-relaxed mt-3 opacity-95">
            Fast, secure personal loans designed to help you get approved and
            funded quickly.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="#advantages" className="hover:text-white/80">
                Why Choose Us
              </a>
            </li>
            <li>
              <a href="#process" className="hover:text-white/80">
                How It Works
              </a>
            </li>
            <li>
              <a href="#mission" className="hover:text-white/80">
                Our Mission
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#apply" className="hover:text-white/80">
                Apply Now
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>support@CashNest Loan Service.com</li>
      ...
      <div className="border-t border-white/20 mt-10 pt-6 text-sm text-center space-y-3">
        <p>© 2019–2026 CashNest Loan Service. All rights reserved.</p>
        ...
        <p className="max-w-3xl mx-auto text-xs leading-relaxed opacity-90">
          ...
          CashNest Loan Service Financial Corp, NMLS #195624.
        </p>
      </div>
    </footer>
  );
