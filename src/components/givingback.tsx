const steps = [
  ...
  },
  {
    ...
    desc: "CashNest Loan Service separately funds twice the loan amount from our resources.",
  },
  {
    number: "03",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 flex flex-col lg:flex-row items-start gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-10 leading-relaxed">
            At CashNest Loan Service, approving your loan is only half the
            story. We commit an equal amount from our own resources to
